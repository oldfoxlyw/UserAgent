...
// 			$parameter['server_debug'] = 1;
		...
		for($i = 0; $i<count($jsonData->server); $i++)
		{
			...
			$ip = random_element($result[$i]->server_ip);
			var_dump($ip);
